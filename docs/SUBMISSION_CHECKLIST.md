...
- Original verified proof baseline: **`83644d1838aadee8fc7acd9150c610aff5402ba7`**.
- Earlier verified hardening source: **cae0bc9db1f0ecf8c6fbb3ab2c5ed1c07a4fae68** (historical proof reference, not the final publication candidate).
- Final publication candidate: the commit introducing [PUBLICATION_CANDIDATE.md](PUBLICATION_CANDIDATE.md). Its full 40-character SHA is recorded in the external release receipt after commit and private push; the file provides a reproducible Git command to obtain it without a self-referential hash.
...
| Named branch contains selected SHA | PASS | Branch is submission-hardening; the frozen publication-candidate commit is identified above and verified against its remote tip. Do not replace it with a short SHA or only a branch URL. |
...
| License | PASS | Apache License 2.0 adopted in the root LICENSE. See LICENSE_RECOMMENDATION.md for scope and retained third-party obligations. Contribution-rights declarations remain part of official review; license selection is complete. |
...
| Private email in tracked text and reachable history | PASS | Pre-publication email metadata rewrite completed. Current tracked text and all reachable commit author/committer metadata and messages were scanned; no private Gmail remains. Advertised remote refs were checked against old history. Local backup refs are retained outside this repository. |
...
1. Confirm the public correspondence email; retain the adopted Apache-2.0 license and applicable third-party notices.
